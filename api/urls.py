...
router.register(r'menu/all', viewsets.MenuItemViewSet, base_name='menuall')
router.register(r'menu/categories', viewsets.MenuCategoryViewSet, base_name='menucategory')
router.register(r'menu/items', viewsets.MenuItemByCategoryViewSet, base_name='menuitem')
